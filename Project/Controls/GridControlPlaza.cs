...
namespace HorarioMaster.Controls
{
    ...
    {
        public GridControlPlaza(string sNamePersonal)
        {
            sName = sNamePersonal;
            InitializeComponent();
        }
        ...
        private void grdPlaza_Load(object sender, EventArgs e)
        {
            ...
            da = DataBaseUtilities.FillDataAdapter("Select * From Plaza WHERE Maestro = '" + sName +"'");
            ...
            AddComboBoxColumn("Select Plaza From Plaza", "", "Plaza", "Plaza");
            HeadersColumnsNames("Maestro,Plaza");
